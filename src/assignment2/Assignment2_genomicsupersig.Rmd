...
gene_list <- read.csv("C:/Users/Esha/Downloads/Assignment2/bioinfo_project/results/SRP164913_diff_expr_results.tsv")
result <- enrichGenomicSuperSignature(SRP164913_diff_expr_results.tsv, gene_list, ontology = "GO")
print(result)
enrichment_table <- as.data.frame(result)
